...
AI    : Google Gemini 2.5 Flash-Lite (무료, 1일 1,000회 / 분 15회)
...
def build_email_html(post, image):
    ...
    return (
        ...
        '<span style="color:#aaa;font-size:11px;">🤖 Gemini 2.5 Flash-Lite | 🖼️ Pexels | ⚙️ GitHub Actions</span>'
        '</div></div></body></html>'
    )
...
def main():
    ...
    print("\n✍️  [2/4] Gemini 2.5 Flash-Lite로 블로그 포스팅 생성 중...")
